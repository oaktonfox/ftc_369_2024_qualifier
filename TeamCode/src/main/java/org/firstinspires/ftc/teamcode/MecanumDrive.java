...
public final class MecanumDrive {
    public static class Params {
        ...
        FORWARD PUSH TEST : _ inches per tick   - 120/4000
    ...
    public boolean isBusy() {
        // Check if the drivetrain motors are currently powered
        return leftFront.getPower() != 0 ||
                leftBack.getPower() != 0 ||
                rightBack.getPower() != 0 ||
                rightFront.getPower() != 0;
    }
    ...
    public Pose2d getPoseEstimate() {
        return pose; // Pose is already being tracked in your class
    }
